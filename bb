...
local whitelist = {"artemy133563", "Edisos000", "TanTai1580", "hazim7201"} 
...
task.spawn(function()	
	local discord = loadstring(game:HttpGet("https://raw.githubusercontent.com/artemy133563/Utilities/main/vv",true))()
	local win = discord:Window("Connect Hub | Ugc Sniper")
	local serv = win:Server("UGC Goblin Hub", "rbxassetid://18142561682")
