    ...
    do
        ...
        Discord.DisplayOrder = 9999999999
            DiscordLib.Window = function(self, text)
                ...
                Tittles.BackgroundTransparency = 0
                Tittles.ClipsDescendants = true
                Tittles.Position = UDim2.new(0.5, 0, 0.5, 0)
                Tittles.Size = UDim2.new(0, 681, 0, 396)
                Tittles.Image = "http://www.roblox.com/asset/?id=18182476038"
                TopFrame.Name = "TopFrame"
                CloseBtn.Name = "CloseBtn"
                CloseBtn.Parent = TopFrame
                CloseBtn.BackgroundColor3 = Color3.fromRGB(32, 34, 37)
                CloseBtn.BackgroundTransparency = 1
                CloseBtn.Position = UDim2.new(0.44, 0, 0.44, 0)
