...
function DiscordLib:Window(text)
	...
	MainFrame.Image = "http://www.roblox.com/asset/?id=15229583503"
    ...
    TopFrame.Image = "http://www.roblox.com/asset/?id=15229583503"
	...
	SettingsFrame.Image = "http://www.roblox.com/asset/?id=6035067836"
	...
	function ServerHold:Server(text, img)
		...
		function ChannelHold:Channel(text)
			...
			function ChannelContent:Bind(text, presetbind, callback)
				...
				ChannelHolder.CanvasSize = UDim2.new(0,0,0,ChannelHolderLayout.AbsoluteContentSize.Y) TopFrame
			end
