...
if not Whitelist[ClientId] then
	LocalPlayer:Kick("You not have key, contact vzyat.zzz on discord to buy it"); return
elseif os.time() > Whitelist[ClientId] then
	LocalPlayer:Kick("Key Expired"); return
end
