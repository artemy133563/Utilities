...
function lib:CreateWindow(title)
	...
	function ChangeGui()
		...
		if hour >= 6 and hour < 12 then
			return "http://www.roblox.com/asset/?id=18398716515"
		elseif hour >= 12 and hour < 15 then
			return "http://www.roblox.com/asset/?id=18398752766"
		elseif hour >= 15 and hour < 18 then
			return "http://www.roblox.com/asset/?id=18398690561"
		elseif hour >= 18 or hour < 6 then
			return "http://www.roblox.com/asset/?id=18398629855"
		else
			return "http://www.roblox.com/asset/?id=18398729785"
		end
	end
	...
	local function ScriptOther() -- LocalScript 
		local script = Instance.new('LocalScript', MainFrame.ImageLabel) 
	...
	MainFrame.TextLabel.InputBegan:Connect(function(input)
		if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
			...
			input.Changed:Connect(function()
				if input.UserInputStatфe == Enum.UserInputState.End then
					dragging = false
				end
			end)
		end
        ...
        function comp1:AddSection(secTitle)
            ...
            function components:AddToggle(buttonTitle, tooltip, default, callback)
                ...
                local toggle = Create("Frame", {
                    ...
                    Create("UIStroke", {
                        ApplyStrokeMode = 1,
                        Color = t1.State and window.AccentColor or Color3.fromRGB(255, 255, 255)
                    }),
                    Create("UICorner", {
                        CornerRadius = UDim.new(0, 4)
                    }),
                    Create("ImageLabel", {
                        ...
                        Image = "http://www.roblox.com/asset/?id=18118482242", 
                        ImageColor3 = window.AccentColor,
