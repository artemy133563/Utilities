...
local Blacklist = {"LARRY_ALWI", "Edisos000"}
if player.LocalPlayer.Name == Blacklist[1] or player.LocalPlayer.Name == Blacklist[2] then
    player.LocalPlayer:Kick("You Not In Whitelist")
...
do
    ...
    Discord.DisplayOrder = 9999999999
        DiscordLib.Window = function(self, text)
            ...
            MainFrame.Image = "http://www.roblox.com/asset/?id=18142346409" 
            ...
            CloseIcon.ImageColor3 = Color3.fromRGB(0, 0, 0)
            ...
            MinimizeIcon.ImageColor3 = Color3.fromRGB(0, 0, 0)
            ...
            ServerHold.Server = function(self, text, img)
                ...
                ChannelHold.Channel = function(self, text)
                    ...
                    ChannelBtnHashtag.TextColor3 = Color3.fromRGB(0, 0, 0)
                        ...
                        function()
                            ...
                            for i, v in next, ServerChannelHolder:GetChildren() do
                                if (v.ClassName == "TextButton") then
                                    ...
                                    v.ChannelBtnTitle.TextColor3 = Color3.fromRGB(0, 0, 0)
                                end
                                ServerFrame.Visible = true
                            end
                    ...
                    ChannelContent.Toggle = function(self, text, default, callback)
                        ...
                        Icon.Image = "http://www.roblox.com/asset/?id=18142362505" 
                        Toggle.MouseButton1Click:Connect(
                            function()
                                if (toggled == false) then
                                    ...
                                    Icon.Image = "http://www.roblox.com/asset/?id=18142369074"
                                    wait(0.1)
                                    TweenService:Create(
                                        Icon,
                                        TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
                    ...
                    ChannelContent.Seperator = function(self)
                        ...
                        Seperator2.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
                    ...
                    ChannelContent.Dropdown = function(self, text, list, callback)
                        ...
                        for i, v in next, list do
                            ...
                            ItemText.BackgroundColor3 = Color3.fromRGB(0, 0, 0)
