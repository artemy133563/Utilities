    ...
    do
        ...
        Discord.DisplayOrder = 9999999999
            DiscordLib.Window = function(self, text)
                ...
                local Tittles = Instance.new("ImageLabel")
                ...
                MainFrame.Image = "http://www.roblox.com/asset/?id=18182815717"  
                ...
                BBBB.BackgroundTransparency = 0.8
                ...
                Tittles.AnchorPoint = Vector2.new(0.24, 0.5)
                Tittles.BackgroundColor3 = Color3.fromRGB(255, 255, 255)
                Tittles.BorderSizePixel = 0
                Tittles.BackgroundTransparency = 1
                Tittles.ClipsDescendants = true
                Tittles.Position = UDim2.new(0.43, 0, 0.5, 0)
                Tittles.Size = UDim2.new(0, 50, 0, 35)
                Tittles.Image = "http://www.roblox.com/asset/?id=18182655756"
                TopFrame.Name = "TopFrame"
                ...
                ServerHold.Server = function(self, text, img)
                    ...
                    ServerWhiteFrame.BackgroundColor3 = Color3.fromRGB(0, 0, 255)
